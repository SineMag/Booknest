        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.description}>
              Your trusted platform for finding the perfect accommodations across South Africa. 
              Discover amazing hotels, apartments, and resorts for your next adventure.
            </p>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.links}>
              ...
              <li><Link to="/dashboard" className={styles.link}>Browse Hotels</Link></li>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactItem}>
                <strong>Office:</strong> 123 Sandton Drive, Sandton, Johannesburg
              </div>
            </div>
          </div>
        </div>
